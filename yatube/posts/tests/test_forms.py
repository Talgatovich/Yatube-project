...
class PostFormTest(TestCase):
    ...
    def test_post_create(self):
        ...
        self.assertRedirects(
            response, reverse("posts:profile", args=((client_user_name,)))
        )
    ...
    def test_guest_cannot_create_post(self):
        ...
        происходит редирект
        """
        form_data = {"text": "Невозможный пост от гостя", "author": self.user}
    ...
    def test_post_edit(self):
        ...
        form_data = {"text": "Обновленный текст", "author": self.user}
    ...
    def test_check_context_with_picture(self):
        ...
        reverse_list = [index, profile, group, post_detail]
    ...
    def test_guest_cannot_create_comments(self):
        ...
        """
        form_data = {"text": "Невозможный коммент от гостя"}
